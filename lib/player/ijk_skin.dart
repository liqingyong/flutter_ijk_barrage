...
const double barHeight = 50.0; //50.0
...
class CustomFijkPanel extends StatefulWidget {
  ...
  final String drawerLabel;//剧集显示标题
  final bool showBarrage;//是否显示弹幕
  ...
  final BarrageWallController barrageWall;//弹幕
  final ValueChanged<bool>? barrageBtnChange;//弹幕按钮点击事件

  CustomFijkPanel({
    required this.player,
    required this.barrageWall,
      ...
      if (_lockStuff == true &&
        ...
        ws.add(
          _buildGestureDetector(
            ...
            drawerLabel: widget.drawerLabel,
            ...
            barrageWall:widget.barrageWall,//弹幕
            barrageBtnChange: widget.barrageBtnChange//弹幕事件
          ),
        );
      }
    }
...
class _buildGestureDetector extends StatefulWidget {
  ...
  final ValueChanged<String>? onSubmitText;//文本提交
  final BarrageWallController barrageWall;//弹幕
  final Function? barrageBtnChange;//弹幕按钮点击事件
...
class _buildGestureDetectorState extends State<_buildGestureDetector> {
  bool get showBarrageB => widget.showBarrage;
  late bool showBarrage =  showBarrageB;
  FijkPlayer get player => widget.player;
  ShowConfigAbs get showConfig => widget.showConfig;
  ...
  //弹幕
  BarrageWallController get _barrageWallController => widget.barrageWall;
  List<Bullet> bullets =[];
/*  List<Bullet>.generate(100, (i) {
    final showTime = new Random().nextInt(60000); // in 60s
    return Bullet(child: Text('$i-$showTime',style: TextStyle(color: Colors.white,fontSize: 18),), showTime: showTime);
  });*/
  //初始化弹幕
  //初始化输入框
  ...
  void initState() {
    ...
    //弹幕
    setState(() {
      _barrageWallController.enabledNotifier = ValueNotifier(showBarrage);
    });
/*
    WidgetsBinding.instance.addPostFrameCallback((_){
      //判断是否为横屏
      if (MediaQuery.of(context).size.width >MediaQuery.of(context).size.height) {
        player.enterFullScreen();//直接进入全屏
      }
    });*/
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Expanded(child:  ListView(
                      ...
                      children: <Widget>[
                        ...
                        ClipRRect(
                          ...
                          child: Container(
                          height: barHeight ,
                          width:  widget.player.value.fullScreen ? curConWidth * 0.62 : curConWidth *0.62, //0.68
                            ...
                            TextField(
                             ...
                             onSubmitted: (val) {
                              ...
                              decoration: const InputDecoration(
                                  ...
                                  labelStyle: TextStyle(height: 16,fontSize: 16,fontWeight: FontWeight.bold,letterSpacing: 2,color: Colors.white),
                                  suffixIcon: Icon(Icons.edit),suffixIconColor: Colors.white)),
                        )),
                        // 剧集按钮
                    ...
                    /*    widget.player.value.fullScreen
                            ?*/ _buildPlayStateBtn(
                            showBarrage
                                ? IconFontIcons.iconBofangqiDanmukai
                                : IconFontIcons.iconBofangqiDanmuguan,
                                () {
                              ...
                              setState(() {
                                ...
                                _barrageWallController.enabledNotifier = ValueNotifier(showBarrage);
                                if (widget.barrageBtnChange!=null) {
                                  widget.barrageBtnChange!(showBarrage);
                                }
                              });
                            }),
                        // 倍数按钮
...
//                    top: 20,
            ...
            child: BarrageWall(
                debug: false,
                safeBottomHeight: 0, // do not send bullets to the safe area
                maxBulletHeight: 32,
                speed: 10,
